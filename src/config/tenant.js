const TENANT_CONFIGS = {
  demo: {
    ...
    cardClassName:
      'rounded-2xl bg-white shadow-lg ring-0 md:ring-2 md:ring-blue-200/70 dark:bg-gray-950 dark:ring-0 md:dark:ring-blue-500/30',
  ...
  klesia: {
    ...
    cardClassName:
      'rounded-2xl bg-white shadow-lg ring-0 md:ring-2 md:ring-[#798AC8]/45 dark:bg-[#2A3D80] dark:ring-0 md:dark:ring-[#D57A36]/40',
  ...
  mh: {
    ...
    cardClassName:
      'rounded-2xl bg-white shadow-lg ring-0 md:ring-2 md:ring-[#E2250C]/25 dark:bg-[#3A201C] dark:ring-0 md:dark:ring-[#E2250C]/40',
  ...
  ircem: {
    ...
    cardClassName:
      'rounded-2xl bg-white shadow-lg ring-0 md:ring-2 md:ring-[#e6007a]/25 dark:bg-gray-950 dark:ring-0 md:dark:ring-[#D51130]/35',
  ...
  'esprit-retraite': {
    ...
    cardClassName:
      'rounded-2xl bg-white shadow-lg ring-0 md:ring-2 md:ring-[#00afcb]/25 dark:bg-gray-950 dark:ring-0 md:dark:ring-[#00afcb]/35',
