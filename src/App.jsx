...
export default function App() {
  ...
  return (
    <div className={`h-dvh w-screen ${tenantConfig.appShellClassName} tenant-${tenantId} antialiased`}>
      <a
        href="#contenu"
        className="sr-only focus:not-sr-only focus:absolute focus:m-4 focus:rounded-none focus:bg-white focus:px-4 focus:py-2 focus:text-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:bg-gray-800"
      >
        Aller au contenu
      </a>
